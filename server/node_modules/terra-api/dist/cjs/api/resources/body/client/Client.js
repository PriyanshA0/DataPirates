...
class Body {
    ...
    __fetch(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e;
            const { user_id: userId, start_date: startDate, end_date: endDate, to_webhook: toWebhook, with_samples: withSamples, } = request;
            const _queryParams = {};
            _queryParams["user_id"] = userId;
            _queryParams["start_date"] = typeof startDate === "string" ? startDate : (0, json_js_1.toJson)(startDate);
            if (endDate != null) {
                _queryParams["end_date"] = typeof endDate === "string" ? endDate : (0, json_js_1.toJson)(endDate);
            }
            if (toWebhook != null) {
            ...
            const _response = yield core.fetcher({
                url: core.url.join((_e = (_d = (yield core.Supplier.get(this._options.baseUrl))) !== null && _d !== void 0 ? _d : (yield core.Supplier.get(this._options.environment))) !== null && _e !== void 0 ? _e : environments.TerraEnvironment.Default, "body"),
                method: "GET",
                headers: _headers,
            ...
            if (_response.error.reason === "status-code") {
                switch (_response.error.statusCode) {
                    ...
                    case 401:
                        throw new Terra.UnauthorizedError(_response.error.body, _response.rawResponse);
                    case 404:
    ...
    __write(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e;
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)(Object.assign({ "dev-id": (_b = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.devId) !== null && _b !== void 0 ? _b : (_c = this._options) === null || _c === void 0 ? void 0 : _c.devId }, (yield this._getCustomAuthorizationHeaders()))), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
    ...
    __delete(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e;
            const { user_id: userId } = request, _body = __rest(request, ["user_id"]);
            const _queryParams = {};
            _queryParams["user_id"] = userId;
            let _headers = (0, headers_js_1.mergeHeaders)((_a = this._options) === null || _a === void 0 ? void 0 : _a.headers, (0, headers_js_1.mergeOnlyDefinedHeaders)(Object.assign({ "dev-id": (_b = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.devId) !== null && _b !== void 0 ? _b : (_c = this._options) === null || _c === void 0 ? void 0 : _c.devId }, (yield this._getCustomAuthorizationHeaders()))), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield core.fetcher({
