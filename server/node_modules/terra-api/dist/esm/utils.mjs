 ...
 */
export function verifyTerraWebhookSignature(payload_1, signatureHeader_1, signingSecret_1) {
    return __awaiter(this, arguments, void 0, function* (payload, signatureHeader, signingSecret, options = {}) {
        let crypto;
        try {
            crypto = yield import("crypto");
        }
        catch (error) {
